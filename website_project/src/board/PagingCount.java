...
public class PagingCount {
  ...
  public String showPaging(int pagelink, String pagename, String find, String search){
    ...
    if(pagelink != 1){
      str = str + "<a href="+pagename+"?pagelink=1&offset=0&find="+find+"&search="+search+"><font size = 2 color=\"blue\"><b>first</b></font>&nbsp;&nbsp;&nbsp;</a>";
    }
    
    bpage = pagelink - 10;
    boffset = countOffset(bpage);
    if(pagelink>links){
      str = str + "<a href="+pagename+"?pagelink="+bpage+"&offset="+boffset+"&find="+find+"&search="+search+"><font size = 2 color=\"black\"><b><<</b></font>&nbsp;&nbsp;&nbsp;</a>";
    }
    ...
    for(cpage = pagelink; cpage < pagelink+links; cpage++){
      ...
      coffset= countOffset(cpage);
      if(cpage!=vpage){
        str = str + "<a href="+pagename+"?pagelink="+cpage+"&offset="+coffset+"&find="+find+"&search="+search+"><font size = 2 color=\"#808074\"><b>"+cpage+"</b></div></a>&nbsp;&nbsp;&nbsp;";
      }else{
        str = str + "<font size=2 color=red><b>"+cpage+"</b></font>&nbsp;&nbsp;&nbsp;";
      }
    }
    ...
    noffset = countOffset(cpage);
    if((totalpage-pagelink) >=links){
      str = str + "<a href="+pagename+"?pagelink="+cpage+"&offset="+noffset+"&find="+find+"&search="+search+"><font size = 2 color=\"black\"><b>>></b></font>&nbsp;&nbsp;&nbsp;</a>";
    }
    
    loffset = countOffset(totalpage);
    if(vpage!=totalpage){
      str = str + "<a href="+pagename+"?pagelink="+totalpage+"&offset="+loffset+"&find="+find+"&search="+search+"><font size = 2 color=\"blue\"><b>last</b></font>&nbsp;&nbsp;&nbsp;</a>";
    }
    str = str + "</td></tr></table>";
    return str;
